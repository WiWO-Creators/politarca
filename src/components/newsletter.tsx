...
export function NewsletterBand() {
  return (
    <section id="newsletter" className="border-t border-border">
      <div className="page-wrap py-12 text-center md:py-20">
        <p className="rubric">El Despacho</p>
        <h2 className="mx-auto mt-3 max-w-[18ch] font-display text-[1.85rem] font-medium tracking-[-0.02em] md:text-4xl">
